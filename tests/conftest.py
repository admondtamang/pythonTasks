...
# WARNING: Ensure imports from `pythontasks` comes after this line
from pythontasks import app, settings, db  # noqa
from pythontasks.cli import create_user, cli  # noqa
