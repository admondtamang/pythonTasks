...
description = """
pythontasks API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://pythontasks.com/terms/",
    contact={
        "name": "admondtamang",
        "url": "http://pythontasks.com/contact/",
        "email": "admondtamang@pythontasks.com",
    },
    license_info={
        "name": "The Unlicense",
